...
# -*- coding: utf-8 -*-
#
# Hunter documentation build configuration file, created by
# sphinx-quickstart on Tue Mar 22 19:58:21 2016.
#
...
latex_documents = [
    (master_doc, 'Hunter.tex', 'Hunter Documentation',
...
man_pages = [
    (master_doc, 'hunter', 'Hunter Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Hunter', 'Hunter Documentation',
     author, 'Hunter', 'CMake-based cross-platform package manager for C++.',
     'Miscellaneous'),
]
